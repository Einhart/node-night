...
var highThresh = 100;
var nIters = 2;
var minArea = 288; // decides minimum size of square. try higher amount for closer square. too small makes squares out of pixels
...
//[30,68,68]
            ...
            imm.inRange([68,110,10], [138,255,255]);//check BLUE hsv
...
if ((solidity > 0.8) && (aspectRatio>=0.7 && aspectRatio<=1.2)){
...
function closing(bx,by,bwidth,bheight){
    if(bwidth<30){
        drone.forward(28); //for forward motion 10 is sufficient. it is more robust than backwards
      setTimeout(function() {
      drone.stop();}, 1);
    }
    else if (bwidth<60){
